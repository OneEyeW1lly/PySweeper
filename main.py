...
class MineField:
    ...
    def reveal_bombs(self, sprite_index=5, endbomb=None):
...
class Game:
    def __init__(self) -> None:
        ...
        self.digits_sheet = SpriteSheet("assets/numbers.png")
    ...
    def end_game(self, final_bomb_sprite_index, final_cell=None):
        self.grid.first_click = False
        #self.running = False
        self.is_dead = True

        self.timer.deactivate()
        self.grid.reveal_bombs(final_bomb_sprite_index, final_cell)
        self.update()
