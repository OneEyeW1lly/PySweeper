...
class Game:
    def __init__(self) -> None:
        ...
        self.timer = Timer()
        self.style_optionbox = OptionBox(SCREEN_WIDTH/2, SCREEN_HEIGHT/2, 200, 55, (255, 255, 255), (230, 230, 230), self.pixel_sans_small, ["PMMine (Mine 2.0)", "WinMine 2.6-2.9", "Windows 95/98", "Windows 3.1/2000", "Windows 3.1/2000 Monochrome", "Prato Fiorito 2000", "Prato Fiorito XP", "Prato Fiorito Monochrome"])
    ...
    def update_options(self):
        ...
        selected_option = self.style_optionbox.update(pygame.event.get())
